...
**DadaLifeSteal 1.0** is a custom Minecraft plugin for Paper/Spigot servers.

Custom Minecraft plugin with dedicated commands and server-side features.

| Field | Value |
| --- | --- |
| Plugin | `DadaLifeSteal` |
| Version | `1.0` |
| Category | Gameplay and Utilities |
| Main class | `it.dadasmp.lifesteal.DadaLifeSteal` |
...
| --- | --- | --- |
| `dadalifesteal.use` | `true` | Permission node. |
| `dadalifesteal.withdraw` | `true` | Permission node. |
| `dadalifesteal.admin` | `op` | Permission node. |
